    ...
    return (
        <>
            ...
            <div className="max-w-4xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <span className="self-center uppercase italic text-3xl font-semibold whitespace-nowrap dark:text-white">My Store</span>
                </Link>
                ...
                <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                    <Link to={"/products"}>Cart : {cartCount}</Link>
                    </li>
                </ul>
                </div>
            </div>
